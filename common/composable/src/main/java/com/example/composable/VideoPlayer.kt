...
fun VideoPlayer(
    ...
    LaunchedEffect(key1 = true) {
        withContext(Dispatchers.IO) {
            val bm = FileUtils.extractThumbnail2("https://firebasestorage.googleapis.com/v0/b/tinyreel3.appspot.com/o/${video.videoLink}?alt=media&token=8b9f9b9e-7b9a-4b7e-9b0a-9b9b9b9b9b9b", 0)
    ...
    if (pagerState.settledPage == pageIndex) {
        val exoPlayer = remember(context) {
            ExoPlayer.Builder(context).build().apply {
                ...
                setMediaItem(MediaItem.fromUri(Uri.parse("https://firebasestorage.googleapis.com/v0/b/tinyreel3.appspot.com/o/${video.videoLink}?alt=media&token=8b9f9b9e-7b9a-4b7e-9b0a-9b9b9b9b9b9b")))
                playWhenReady = true
                prepare()
